...
open class WebMvcConfig: WebMvcConfigurer {
    ...
    @Bean
    open fun getFilterRegistrationBean() : FilterRegistrationBean<HeaderFilter>{
...
//    @Bean
//    open fun createHeaderFilter() : HeaderFilter = HeaderFilter()
//
//    @Bean
//    open fun jwtTokenInterceptor() : JwtTokenInterceptor = JwtTokenInterceptor()
}